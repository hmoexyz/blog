...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "红萌视频",
			url: "https://hmoe.xyz/", // Internal links should not include the base path, as it is automatically added
	...
	links: [
		{
			...
			url: "https://twitter.com/HmoeXyz",
		},
		{
			name: "GitHub",
			icon: "fa6-brands:github",
			url: "https://github.com/hmoexyz",
		},
	],
};
